...
export class ReaderSession {
	...
	async open(): Promise<void> {
		...
		this.overlay.setFitMode(getPref<'strict' | 'expand'>('overlayFitMode', 'strict'));
		this.pane.setOverlayEnabled(getPref<boolean>('overlayEnabled', false));
		this.overlay.setEnabled(getPref<boolean>('overlayEnabled', false));
	...
	cycleOverlayMode(): OverlayDisplayMode {
		const order: OverlayDisplayMode[] = ['dim-original', 'translation-only', 'hover'];
