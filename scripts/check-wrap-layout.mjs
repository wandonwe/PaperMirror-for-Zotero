...
try {
 ...
 writeFileSync(join(temporary,'check.html'), '<!doctype html><meta charset="utf-8"><style>'+readFileSync(join(root,'src/ui/styles/translationPane.css'),'utf8')+'</style><script>window.captionFixtureImage="data:image/png;base64,'+readFileSync(join(root,'tests/fixtures/regression/simohamed2021-p4.png')).toString('base64')+'";</script><script defer src="check.js"></script>');
